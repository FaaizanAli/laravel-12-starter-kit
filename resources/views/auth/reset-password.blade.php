        ...
        <div class="container flex items-center justify-center">
            <div class="w-full md:w-1/2 xl:w-1/3">
                ...
                @endif
                    ...
                    @endif
                <form class="card mt-5 p-5 md:p-10" action="{{route('change.password.post')}}" method="POST" id="reset_password">
                    @csrf
                    <div class="mb-5">
...
@section('script')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\web\ResetPasswordRequest', '#reset_password'); !!}
@endsection
